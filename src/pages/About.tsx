// ============================================================
// ABOUT US — single page covering: Our Story, The House,
// A Day at Ohana, Meet the Team, Life in Morocco
// ============================================================
...
declare const DAY_AT_OHANA: any[];
      ...
      <div className="split">
        <div style={{position:"relative"}}>
          <div className="split__media">
            <img
              src="assets/images/about-story-2.jpg"
              alt="A family that surfs together"
            />
          </div>
    ...
    <Section id="day">
      <div className="day-layout">
        <div className="day-layout__left">
          ...
          <div>
            <Button variant="teal" iconRight="arrow-right" href="#booking">Check availability</Button>
          </div>
        </div>
...
function AboutPage({ go }: { go: (r: Route) => void }) {
  return (
    <main>
      <PageHeader
        eyebrow="About us"
